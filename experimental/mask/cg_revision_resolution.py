...
if __name__ == "__main__":
    ...
    res = tomoalign.cg(data, theta, pprot, pnz, center, ngpus, nitercg)
    dxchange.write_tiff_stack(res['u'], fname+'/results_cgnr1/u/r', overwrite=True)
    ...
    res = tomoalign.cg(data, theta, pprot, pnz, center, ngpus, nitercg)
    dxchange.write_tiff_stack(res['u'], fname+'/results_cgnr2/u/r', overwrite=True)
