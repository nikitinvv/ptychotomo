...
if __name__ == "__main__":
    ...
    dxchange.write_tiff_stack(data[400//pow(2,binning):800//pow(2,binning)], out_file+'/r', overwrite=True)
    ...
    data=dxchange.read_tiff_stack(out_file+'/r_00000.tiff', ind=[(651-400)//pow(2,binning),(618-400)//pow(2,binning),(632-400)//pow(2,binning)])
# 125,108,116
    #bin0 cutes    
    plt.imsave(out_file+'/z1.png',data[0],vmin=-0.0015*pow(2,binning),vmax=0.0015*pow(2,binning),cmap='gray')
    plt.imsave(out_file+'/z2.png',data[1],vmin=-0.0015*pow(2,binning),vmax=0.0015*pow(2,binning),cmap='gray')
    plt.imsave(out_file+'/z3.png',data[2],vmin=-0.0015*pow(2,binning),vmax=0.0015*pow(2,binning),cmap='gray')