...
if __name__ == "__main__":
    ...
    for k in range(ntheta):        
        psiangle = dxchange.read_tiff(f'{data_prefix}rec_crop_cm/psiangle/r{k}.tiff')  
        ...
        psi[k] = psiangle[:,psiangle.shape[1]//4]
    ...
    for center in range(n//2-10,n//2+40):
        ...
        with ptychotomo.SolverTomo(theta, ntheta, nz, n, pnz, center, ngpus) as tslv:
            ...
            dxchange.write_tiff(u[0].real,data_prefix+'test_center_crop_cm/r'+str(center)+'.tiff',overwrite=True)
