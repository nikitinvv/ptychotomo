...
for k in range(ntheta):
    img0[k] = dxchange.read_tiff(data_prefix+'pgm2/'+str(k)+'.tiff')
...
dxchange.write_tiff_stack(imgres.astype('float32'),data_prefix+'prealign_sift2/r.tiff',overwrite=True)
print(shifts)
np.save(data_prefix+'/datanpy/shifts2.npy',shifts)