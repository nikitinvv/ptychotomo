...
if __name__ == "__main__":
    ...
    data_sift = dxchange.read_tiff_stack(data_prefix+'rec_full_sorted_aligned/r_0000.tif', ind=np.arange(0,ntheta)).astype('float32')    
    ...
    for k in range(ntheta):
        ...
        shift[k]=shift0
    dxchange.write_tiff_stack(data,data_prefix+'rec_full_sorted_aligned_check/psiangle'+str(nmodes)+str(nscan)+'/r.tiff',overwrite=True)                
