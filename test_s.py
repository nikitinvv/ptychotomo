...
if __name__ == "__main__":
    ...
    if(sys.argv[1] == "True"):
        ...
        # Save result
        dxchange.write_tiff(x.beta,  '../rec_ptycho/beta_s/beta_joint_60over')
        dxchange.write_tiff(
            x.delta,  '../rec_ptycho/delta_s/delta_joint_60over')
    ...
    for k in range(idc, idc+1):
        ...
        dxchange.write_tiff(
            x.beta,   '../rec_ptycho/beta/beta_joint_60over_' + str(maxint)+'_maxint_noise')
        dxchange.write_tiff(
            x.delta,  '../rec_ptycho/delta/delta_joint_60over_'+str(maxint)+'_maxint_noise')
